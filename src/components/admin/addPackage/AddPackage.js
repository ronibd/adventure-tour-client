...
const AddPackage = () => {
  ...
  const handleAddPackage = () => {
    ...
    if (
      ...
      fetch("https://shielded-escarpment-78906.herokuapp.com/submitPackage", {
        method: "POST",
        ...
        .then((data) => {
          if (data) {
            ...
            window.alert(
              "Error Occure. Check your internet connection and try again.."
            )
          }
        })
    }
    ...
    <div>
      ...
      <div className="bg-light p-5 m-3">
        ...
        <input
          ...
          className="form-control mb-3 me-3"
          type="text"
          placeholder="Image URL (Ex: https://i.ibb.co/n7Ky0hV/image-40.png)"
        />
        <input
          id="priceInput"
          className="form-control mb-3"
